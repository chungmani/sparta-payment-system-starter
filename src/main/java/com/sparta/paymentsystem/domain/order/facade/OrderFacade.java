...
public class OrderFacade {
    ...
    public CheckoutResponse getCheckout(Long memberId, List<Long> cartItemIds) {
        ...
        // 장바구니 주문 총액을 구한다. CheckoutResponse.CheckoutItemResponse의 subTotal을 모두 던한다.
    ...
    private List<CartItem> getValidateCartItem(Long memberId, List<Long> cartItemIds) {
        // cartItemIds가 비어있으면 "전체 장바구니", 아니면 "선택 아이템만" 조회
        ...
        // 1차 검증: 주문할 아이템이 하나도 없으면 주문서 자체가 성립이 안됨.
        // (전체 조회: 빈 장바구니 / 선택 조회: 넘긴 ID가 전부 남의 것/없는 것일때도 여기로 떨어짐)
